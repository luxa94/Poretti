...
INSERT INTO `user_permission` (`user`, `permission`) VALUES (2, 'CREATE_ADVERTISEMENT'), (2, 'EDIT_ADVERTISEMENT'), (2, 'DELETE_ADVERTISEMENT'), (2, 'CREATE_REVIEW'), (2, 'CREATE_ADVERTISEMENT_REPORT'), (2, 'APPROVE_COMPANY_USER'), (2, 'REMOVE_USER_FROM_COMPANY'), (2, 'JOIN_COMPANY'), (2, 'LEAVE_COMPANY'), (2, 'EDIT_COMPANY');
