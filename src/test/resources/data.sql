...
INSERT INTO `userpermission` (`user`, `permission`) VALUES (3, 'CREATE_ADVERTISEMENT'), (3, 'EDIT_ADVERTISEMENT'), (3, 'DELETE_ADVERTISEMENT'), (3, 'CREATE_ADVERTISEMENT_REPORT'), (3, 'CREATE_REVIEW'), (3, 'DELETE_REVIEW');
